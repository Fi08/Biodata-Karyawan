...
<body class="bg-gradient-primary container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">PT. NIPPISUN INDONESIA</h1>
                            </div>
                            <?php
                            session_start();
                            if (isset($_SESSION['login'])) {
                            ?>
                                <div class="alert alert-<?= $_SESSION['Tlogin'] ?>" role="alert">
                                    <?= $_SESSION['login']  ?>
                                </div>
                            <?php
                            ...
                            <form class="user" method="POST" action="cek_login.php">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nomer Induk Kependudukan" name="nik">
                                </div>
                                <div class="form-group">
